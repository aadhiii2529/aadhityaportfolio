      ...
      >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {softSkills.map((skill) => (
                <div 
                  key={skill} 
                  className="bg-background rounded-lg p-4 flex items-center border border-border transition-all hover:border-accent hover:shadow-sm"
                >
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Python", "Java", "IoT Devices", "Arduino", "Raspberry Pi", "Git", "Circuit Design", "Communication Networks"].map((tech) => (
              <span 
                key={tech} 
                className="px-4 py-2 bg-background rounded-full text-sm font-medium border border-border hover:border-accent transition-colors"
              >
                {tech}
              </span>
            ))}
